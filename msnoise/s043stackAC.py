...
def main(stype, interval=1):
    ...
    #check if comp available in data availability
    ...
    for f in get_filters(db, all=False):
        ...
        for components in pairs:
            ...
            for station in stations:
                ...
                updated_days = updated_days_for_dates(db, start, end, station, jobtype='AC', interval=datetime.timedelta(days=interval),returndays=True)
